package com.itcast.bos.service.realms;
...
import com.itcast.bos.dao.system.UserRepository;
       ...
       User user = (User) subject.getPrincipal();
        if("admin".equals(user.getUsername())) {
         // 内置管理员的权限和角色是写死的
            ...
            List<Permission> permissons = permissonRepository.findAll();
            ...
            List<Permission> permissons =permissonRepository.findbyUid(user.getId());
            for (Permission permission : permissons) {
                info.addStringPermission(permission.getKeyword());
            }
        }
