...
public class ImageAction extends ActionSupport {
    ...
    /*
     * // 属性驱动获取文件类型 private String imgFileContentType;
     * 
     * public void setImgFileContentType(String imgFileContentType) { this.imgFileContentType =
     * imgFileContentType; }
     */
