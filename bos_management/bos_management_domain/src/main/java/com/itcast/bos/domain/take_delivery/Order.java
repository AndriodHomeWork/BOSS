package com.itcast.bos.domain.take_delivery;  
/**  
 * ClassName:Order <br/>  
 * Function:  <br/>  
 * Date:     2018年3月24日 上午9:45:06 <br/>       
 */
...
public class Order {
    ...
    public WorkBill getWayBill() {
        return wayBill;
    }

    public void setWayBill(WorkBill wayBill) {
